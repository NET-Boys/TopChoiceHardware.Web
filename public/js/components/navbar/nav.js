            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 mx-auto">
                    <li class="nav-item">
                      <div class="wrap">
                        <div class="search">
                            <input id="input-busqueda" type="text" class="searchTerm" placeholder="¿Que estás buscando?"> 
                            <button id="buscar-producto" type="button" class="searchButton">
...
`
export const NavSinLoginSinBusqueda = () =>`
<nav class="navbar navbar-expand-lg navbar-dark bgcolor" id="navegador">
        <div class="container-fluid">
          <a id="imagen-logo" class="navbar-brand logo-empresa" href="../../">
            <img  src="../img/logo.png" height="80" alt="" loading="lazy" style="margin-top: -1px;"/>
...
export const NavConLoginSinBusqueda = (email) =>`
<nav class="navbar navbar-expand-lg navbar-dark bgcolor" id="navegador">
        <div class="container-fluid">
          <a id="imagen-logo" class="navbar-brand logo-empresa" href="../../">
            <img  src="../img/logo.png" height="80" alt="" loading="lazy" style="margin-top: -1px;"/>
